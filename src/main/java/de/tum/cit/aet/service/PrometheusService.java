...
import de.tum.cit.aet.prometheus.MetricValue;
import de.tum.cit.aet.prometheus.QueryResponse;
...
public class PrometheusService {
    ...
    private List<MetricValue> getCpuUsage(SimulationRun run, String instance) {
        ...
        Arrays.stream(res.getData().getResult()).forEach(r ->
            Arrays.stream(r.getValues()).forEach(v -> {
