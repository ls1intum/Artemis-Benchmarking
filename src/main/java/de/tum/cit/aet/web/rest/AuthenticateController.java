...
public class AuthenticateController {
    ...
    @Value("${benchmarking.security.authentication.jwt.token-validity-in-seconds:0}")
    private long tokenValidityInSeconds;

    @Value("${benchmarking.security.authentication.jwt.token-validity-in-seconds-for-remember-me:0}")
